...
//
//
// $Id: CustomG4OpBoundaryProcess.hh 104458 2017-05-31 15:54:11Z gcosmo $
//
// 
////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////
//
// File:        CustomG4OpBoundaryProcess.hh
...
#ifndef C4OpBoundaryProcess_h
#define C4OpBoundaryProcess_h 1
...
private:
        ...
        C4OpBoundaryProcess(const C4OpBoundaryProcess &right);

        //////////////
        // Operators
        //////////////

        C4OpBoundaryProcess& operator=(const C4OpBoundaryProcess &right);
...
inline
G4bool C4OpBoundaryProcess::G4BooleanRand(const G4double prob) const
{
...
inline
G4bool C4OpBoundaryProcess::IsApplicable(const G4ParticleDefinition& 
                                                       aParticleType)
{
...
inline
G4OpBoundaryProcessStatus C4OpBoundaryProcess::GetStatus() const
{
   return theStatus;
}

inline
void C4OpBoundaryProcess::SetInvokeSD(G4bool flag)
{
  fInvokeSD = flag;
}

/**
C4OpBoundaryProcess::ChooseReflection
----------------------------------------------

Defaults of prob_ss, prob_sl, prob_bs are all 0. 


**/

inline
void C4OpBoundaryProcess::ChooseReflection()
{
...
inline
void C4OpBoundaryProcess::DoAbsorption()
{
...
inline
void C4OpBoundaryProcess::DoReflection()
{
