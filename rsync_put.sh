...
src=/Users/blyth/customgeant4/         ## for rsync a trailing slash on source directory means copy contents of this directory
dst=P:/home/blyth/customgeant4
...
if [ "${arg/wc}" != "$arg" ]; then
   read -p "$BASH_SOURCE : CAUTION UNTESTED : this will delete .git at the other end, enter YES to continue " answer
   if [ "$answer" == "YES" ]; then  
